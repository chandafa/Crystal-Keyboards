      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-[60] bg-[#050510] text-white flex flex-col justify-between p-6 md:p-12"
          >
            <div className="flex justify-between items-center">
              <div className="text-xl font-bold tracking-tighter uppercase font-outfit text-[#94a3b8]">
                Crystal Keyboards
              </div>
              <button
                onClick={() => setIsOpen(false)}
                className="flex items-center gap-2 text-sm uppercase tracking-widest hover:opacity-70 transition-opacity text-[#94a3b8]"
              >
                Close <X size={20} />
              </button>
            </div>
            ...
            <div className="flex flex-col gap-4 justify-center items-start h-full">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="text-6xl md:text-8xl font-bold uppercase tracking-tighter hover:text-[#94a3b8] transition-colors font-outfit overflow-hidden"
                  onClick={() => setIsOpen(false)}
                >
            ...
            <div className="flex justify-between items-end text-[#94a3b8] text-sm uppercase tracking-widest">
